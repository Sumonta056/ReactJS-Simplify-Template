...
const Index = () => {
  return (
    <div className="w-full h-full py-[10rem] px-4 bg-[#86efac]">
      <div className="m-20">
        <Accordion collapseAll={true}>
          ...
          <Accordion.Panel>
            ...
            <Accordion.Content>
              <p>
                The Keep React offers a range of color variants for components.
                To customize the color scheme, you can use the available color
                options such as gray,info,error,warning and success. Simply set
                the desired color variant as a prop when using the component,
